      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative bg-[#EEF1F6] text-gray-900 rounded-3xl overflow-hidden shadow-sm p-8 sm:p-12 lg:p-16 flex flex-col lg:flex-row items-center justify-between gap-12 border border-gray-100">
          ...
          <div className="w-full lg:w-1/2 flex flex-col items-start space-y-6 relative z-10">
            ...
            >
              There's a place for everyone to serve at RCCG Rehoboth Parish. Whether you're passionate about worship, media, children's ministry, or community outreach, we'd love to have you on the team.
            </motion.p>
          ...
          <div className="w-full lg:w-1/2 flex justify-center items-center relative">
            <motion.div
              ...
              className="relative p-3 rounded-3xl border border-gray-200 bg-white shadow-sm max-w-[400px] w-full"
            >
