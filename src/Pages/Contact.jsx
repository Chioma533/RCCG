      ...
      <section className="relative  min-h-[90vh]  flex items-center justify-center bg-black overflow-hidden">
        ...
        <div className="relative z-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center text-white">
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-7.5xl font-serif font-bold text-white mb-6 tracking-tight leading-[1.1] max-w-4xl"
          >
            We Can't Wait to
            <br />
            Welcome You
          ...
          >
            ...
            home, we'd love to worship with you. Come as you are and experience
            a welcoming community centered on Christ.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-full lg:w-1/2 flex justify-center items-center relative z-10">
              <div className="relative p-3 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm max-w-120 w-full">
